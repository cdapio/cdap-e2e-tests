...
public class CdfSysAdminActions {
  ...
  /**
   * Verify if System admin page is displayed
   */
  public static void verifySystemAdminPageIsDisplayed() {
    ElementHelper.isElementDisplayed(CdfSysAdminLocators.systemText);
  }

  /**
   * Verify if the added Preferences reset is successfully
   */
  ...
  public static void verifyProvisionerPresentComputeProfile(String profileTitle) {
    WaitHelper.waitForElementToBeOptionallyDisplayed(CdfSysAdminLocators.
